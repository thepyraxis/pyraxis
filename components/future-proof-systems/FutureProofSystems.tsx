  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-[1240px]">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-split lg:items-start lg:gap-10">
          <div>
          ...
          <div className="flex items-start gap-2 overflow-x-auto pb-2">
            {futureProofPillars.map((pillar, index) => {
              ...
              return (
                <div key={pillar.id} className="flex shrink-0 items-start">
                  <div className="flex w-[168px] flex-col rounded-[24px] border border-border/70 bg-card/40 p-6 shadow-[0_0_16px_rgba(139,92,246,0.06)]">
                  ...
                  {index < futureProofPillars.length - 1 && (
                    <span aria-hidden="true" className="mt-16 hidden px-1 text-purple-500/60 lg:block">
                      →
                    </span>
                  )}
                </div>
