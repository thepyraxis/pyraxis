...
/**
 * Interactive contour-line field background. Ported from the standalone
 * NexusNode reference page (raw WebGL, no three.js): a single fullscreen
 * triangle running one fragment shader that draws simplex-noise contour
 * bands, tinted white to keep this section's deliberately quiet,
 * near-monochrome palette (see FounderStory.tsx) rather than pulling in
 * the purple accent used elsewhere on the page.
 *
 ...
 *    and no click ripple.
 * Gate behind desktop tier only via ResponsiveCanvas at the call site.
 */
...
export default function ContourFieldBackground({ sectionRef, className }: Props) {
  ...
  useEffect(() => {
    ...
    // White tint — keeps Founder Story's near-monochrome palette rather
    // than the purple accent used elsewhere on the page.
